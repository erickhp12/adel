...
from agenda.views import AgendaListView, CreateAgendaView, UpdateAgendaView,DetailAgendaView
...
urlpatterns = [
	...
	url(r'^agenda/ver/(?P<pk>\d+)/$',DetailAgendaView.as_view(),name='ver_agenda'),
