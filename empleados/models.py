...
class Empleado(models.Model):
    nombres = models.CharField(max_length=200, null=False, unique=True, verbose_name=u'nombre(s)')
    ...
    direccion = models.CharField(max_length=200,default='0',null=False,unique=False,verbose_name=u'Direccion')
